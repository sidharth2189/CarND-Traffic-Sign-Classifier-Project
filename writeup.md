...
The images from the web have different pixel height and width from what the network accepts. So, they are resized using cv2.resize() function and preprocessed by grayscaling and normalizing.
